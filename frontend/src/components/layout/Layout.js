    ...
    return (
        <div className={`flex min-h-screen bg-background text-foreground overflow-hidden selection:bg-emerald-500/30 transition-colors duration-500`}>
            ...
            <div className="flex-1 flex flex-col h-screen overflow-hidden relative">
                {/* Header */}
                <header className={`sticky top-0 z-40 bg-background/80 backdrop-blur-3xl border-b border-border px-6 py-4 flex items-center justify-between transition-all duration-500`}>
                    <div className="flex items-center gap-4">
                        ...
                        <button 
                            ...
                            className={`hidden md:flex size-11 rounded-2xl bg-muted border border-border text-muted-foreground hover:text-emerald-500 items-center justify-center hover:border-emerald-500/30 hover:bg-emerald-500/10 transition-all group`}
                        ...
                        <div className="hidden sm:block ml-2">
                            <h2 className={`font-display font-black text-2xl text-foreground tracking-tighter transition-colors`}>{title}</h2>
                            <p className={`text-[9px] uppercase tracking-[0.3em] text-muted-foreground font-bold`}>BoothIQ Intelligence Matrix</p>
                        </div>
                    </div>

                    <div className="flex items-center gap-4">
                        {/* Search - Desktop */}
                        <div className={`hidden lg:flex items-center gap-3 bg-muted px-5 py-2.5 rounded-2xl border border-border focus-within:border-emerald-500/50 transition-all w-72 mr-4 group`}>
                            <Search size={16} className={`text-muted-foreground group-focus-within:text-emerald-500 transition-colors`} />
                            <input 
                                type="text" 
